    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center max-w-4xl mx-auto">
        ...
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          Discover how our innovative irrigation solutions have revolutionized
          farming operations across diverse landscapes and climates.
        </p>
      </div>
    </div>
  </section>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4">
        ...
        {showFilters && (
          <div
            id="filter-panel"
            className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-background rounded-xl border border-border shadow-md"
          >
            <div>
              <label
        ...
        <div className="bg-background shadow-md rounded-xl p-6">
          ...
          >
            {Array.from({ length: ITEMS_PER_PAGE }).map((_, index) => (
              <Card
                key={index}
                className="overflow-hidden bg-background border-border shadow-md animate-pulse"
              >
                {viewMode === "grid" ? (
                  <>
...
const Projects: React.FC<ProjectsProps> = ({ supabaseClient = supabase }) => {
  ...
  const filteredAndSortedProjects = useMemo(() => {
    let filtered = projects.filter((project) => {
      ...
      return (
        matchesSearch && matchesStatus && matchesProjectType && matchesLocation
      );
    });
    ...
    filtered.sort((a, b) => {
      switch (sortBy) {
        ...
        case "area":
          return (b.area_covered || 0) - (a.area_covered || 0);
        case "water_saved":
          return (b.water_saved || 0) - (a.water_saved || 0);
        default:
          return 0;
      }
    });
