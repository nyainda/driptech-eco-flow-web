...
import { 
  Play, Clock, Eye, AlertTriangle, Star, X, ExternalLink, 
  Search, Filter, Grid, List, ArrowUpDown, Calendar,
  Maximize, Minimize, Info, Share2, ThumbsUp, Download,
  SkipForward, Volume2, Settings, MoreVertical
} from "lucide-react";
...
const VideosPage = () => {
  ...
  const incrementViews = async (videoId: string) => {
    try {
      ...
      // Refetch to update the views count
      refetch();
    } catch (error) {
  ...
  const handlePlayNext = () => {
    if (relatedVideos.length > 0) {
      handleWatchVideo(relatedVideos[0]);
    }
  };
      ...
      <>
        ...
        <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 flex items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">Error Loading Videos</h3>
        ...
        {currentVideos.length === 0 ? (
          ...
          <div className={viewMode === "grid" 
            ...
            {currentVideos.map((video) => {
              ...
              // Grid view (same as before but responsive)
              return (
