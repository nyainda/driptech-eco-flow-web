  ...
  const certifications = [
    {
      ...
      description:
        "Certified quality management system ensuring consistent service delivery and customer satisfaction.",
      icon: Shield,
      status: "Active",
      priority: "high",
    },
    {
      ...
      description:
        "Professional certification for irrigation system design and water management expertise.",
      icon: Award,
      status: "Active",
      priority: "high",
    },
    {
      ...
      description:
        "Certification in smart irrigation technologies and water-efficient application methods.",
      icon: CheckCircle,
      status: "Active",
      priority: "medium",
    },
    {
      ...
      description:
        "Specialized certification in sustainable water management and conservation practices.",
      icon: Shield,
      status: "Active",
      priority: "medium",
    },
    {
      ...
      description:
        "Government-recognized certification for agricultural technology implementation and support.",
      icon: Award,
      status: "Active",
      priority: "high",
    },
    {
      ...
      description:
        "Certification ensuring environmentally responsible business practices and sustainability.",
      icon: CheckCircle,
      status: "Active",
      priority: "medium",
    },
  ...
  const achievements = [
    {
      ...
      description:
        "Successfully completed installations with quality assurance",
    },
    {
      icon: Building,
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              DripTech maintains the highest industry standards through
              continuous certification and professional development. Our
              credentials ensure quality, safety, and expertise in every
              project.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {achievements.map((achievement, index) => (
              <Card
                key={index}
                className="text-center p-6 bg-background border-2 border-border/20 hover:shadow-2xl hover:border-primary/20 hover:scale-[1.02] transition-all duration-500 group"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {certifications.map((cert) => (
              <Card
                key={cert.id}
                className={`bg-background border-2 border-border/20 hover:shadow-2xl hover:border-primary/20 hover:scale-[1.02] transition-all duration-500 border-l-4 ${getPriorityColor(cert.priority)}`}
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <Badge
                      className={`text-sm font-semibold ${getStatusColor(cert.status)}`}
                    >
                      {cert.status}
                    </Badge>
                  </div>
                ...
                <CardContent>
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full rounded-xl hover:bg-primary/10 hover:shadow-lg hover:scale-105 transition-all duration-300"
                  >
          ...
          <Card className="mb-16 bg-background border-2 border-border/20 hover:shadow-2xl hover:border-primary/20 hover:scale-[1.02] transition-all duration-500">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg max-w-3xl mx-auto text-muted-foreground leading-relaxed">
                Every certification represents our dedication to excellence,
                continuous improvement, and customer satisfaction. We invest in
                training and development to stay ahead of industry standards.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ISO certified processes ensure consistent quality in every
                    project delivery.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Certified professionals with ongoing training and
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Full compliance with industry regulations and environmental
                    standards.
                  </p>
                </div>
              </div>
          ...
          <Card className="bg-background border-2 border-border/20 hover:shadow-2xl hover:border-primary/20 hover:scale-[1.02] transition-all duration-500">
            <CardContent className="p-8 text-center bg-gradient-to-br from-primary/5 to-secondary/5">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto leading-relaxed">
                For verification of our certifications or to request official
                documentation, please contact our certification department.
              </p>
