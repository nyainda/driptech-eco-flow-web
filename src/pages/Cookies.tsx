        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              How DripTech EcoFlow uses cookies and similar technologies on our
              website
            </p>
          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  They help us provide you with a better browsing experience by
                  remembering your preferences and understanding how you
                  interact with our site.
                </p>
                <div className="bg-muted/50 p-4 rounded-lg">
                  <p className="text-sm">
                    <strong>In Simple Terms:</strong> Think of cookies as
                    digital sticky notes that help our website remember useful
                    information about your visit, making your experience
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Required for basic website functionality. Cannot be
                      disabled.
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground text-sm">
                      ...
                      <li>
                        Save your location for relevant service information
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground text-sm">
                      <li>
                        Understand which irrigation solutions are most popular
                      </li>
                      <li>
                        Identify areas where customers need more information
                      </li>
                      <li>Optimize website performance and speed</li>
                      <li>
                        Improve our service offerings based on user behavior
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground text-sm">
                      <li>
                        Show irrigation solutions suitable for your region
                      </li>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  ...
                  that we use to enhance functionality. These partners have
                ...
                <div className="space-y-4">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Enable sharing of content on social media platforms like
                      Facebook, Twitter, and LinkedIn.
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Each platform has its own privacy policy governing cookie
                      use.
                    </p>
                  </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-2">
                      Stay on your device for a set period or until manually
                      deleted.
                    </p>
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground text-xs">
            ...
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  You have full control over cookies on our website. You can
                  accept, reject, or manage specific types of cookies according
                  to your preferences.
                </p>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-3">
                      ...
                      settings. Here's how to access cookie settings in popular
                      browsers:
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                        ...
                        <li>
                          <strong>Opera:</strong> Settings → Advanced → Privacy
                          & Security
                        </li>
                        <li>
                          <strong>Mobile Browsers:</strong> Check
                          browser-specific help pages
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  While you can browse our website with cookies disabled, some
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  practices. Any changes will be posted on this page with an
