  ...
  const services = [
    {
      ...
      description:
        "Professional installation of all irrigation systems with precision and care.",
      expertise: [
        "Drip systems",
    ...
    },
    {
      ...
      description:
        "Comprehensive training on system operation and maintenance best practices.",
      expertise: [
        "Operator training",
    ...
    },
    {
      ...
      description:
        "Regular maintenance and emergency repair services to ensure optimal performance.",
      expertise: [
    ...
    },
    {
      ...
      title: "24/7 Support",
      description:
        "Round-the-clock technical support for critical irrigation system issues.",
      expertise: [
        "Emergency response",
        "Remote diagnostics",
        ...
        <section className="py-20 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Meet our team of certified irrigation technicians with years of
              experience in designing, installing, and maintaining irrigation
        ...
        <section className="py-20 bg-gradient-to-b from-muted/20 to-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Our certified technicians provide comprehensive irrigation
                services
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {certifications.map((cert, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 p-4 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-lg"
                >
