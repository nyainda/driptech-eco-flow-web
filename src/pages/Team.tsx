...
import { Linkedin, Mail, Phone, Users, Star, Sparkles, Crown } from "lucide-react";
        ...
        <section className="relative py-32 bg-gradient-to-br from-primary/10 via-background to-accent/5 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="inline-flex items-center gap-3 mb-8">
              <Badge variant="secondary" className="px-6 py-3 text-base font-semibold bg-primary/10 text-primary border-primary/20 hover:bg-primary/15 transition-colors">
              ...
              <div className="flex gap-1">
                ...
                <Star className="w-3 h-3 text-yellow-400 fill-yellow-400 animate-pulse" style={{ animationDelay: '0.4s' }} />
              </div>
            </div>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
              ...
              <span className="relative inline-block">
                ...
                <Sparkles className="absolute -top-8 -right-8 w-8 h-8 text-primary animate-spin" style={{ animationDuration: '3s' }} />
              </span>
            </h1>
            
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed">
              Our experienced professionals are dedicated to delivering{" "}
              <span className="text-foreground font-semibold">innovative irrigation solutions</span>{" "}
            ...
            <div className="flex flex-wrap justify-center gap-8 text-center">
              ...
              <div className="bg-background/60 backdrop-blur-sm border border-border/50 rounded-2xl px-6 py-4 shadow-lg">
                <div className="text-2xl font-bold text-primary">{team.filter(m => m.featured).length}</div>
                <div className="text-sm text-muted-foreground">Lead Experts</div>
              </div>
            </div>
          </div>
        </section>
            ...
            {loading ? (
                      ...
                      <div className="relative mb-8">
                        ...
                        {member.featured && (
                          <div className="absolute -top-3 -right-3 group-hover:scale-110 transition-transform duration-300">
                            <Badge variant="secondary" className="px-3 py-1 text-xs font-bold bg-gradient-to-r from-yellow-400 to-orange-400 text-white border-0 shadow-lg flex items-center gap-1">
              ...
              <div className="text-center py-24">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-2xl font-bold text-foreground mb-4">No Team Members Available</h3>
                  <p className="text-lg text-muted-foreground mb-2">Team members will be displayed here once they are added.</p>
                  <p className="text-sm text-muted-foreground/80">Use the admin dashboard to add and manage team members.</p>
                </div>
              </div>
            )}
          </div>
