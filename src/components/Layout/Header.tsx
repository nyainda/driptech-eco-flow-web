...
const Header = () => {
  ...
  const handleCloseBanner = (bannerId: string) => {
    ...
    if (remainingBanners.length === 0) {
      ...
      const newIndex =
        currentBannerIndex >= remainingBanners.length ? 0 : currentBannerIndex;
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-xl">
      ...
      {showBanner && currentBanner && (
        ...
        >
          ...
          <div
            className={`relative py-2 px-4 transition-all duration-600 ${
              isTransitioning
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <QuoteModal>
              <Button
                variant="outline"
                className="hidden md:flex hover:bg-primary hover:text-primary-foreground transition-colors"
              >
                Get Quote
              </Button>
            </QuoteModal>
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              <SheetTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="lg:hidden hover:bg-muted/50 h-10 w-10 rounded-xl"
                >
              ...
              <SheetContent
                side="right"
                className="w-[90vw] max-w-md p-0 bg-background/98 backdrop-blur-xl border-l shadow-2xl"
              >
                    ...
                    <div className="p-4 space-y-6">
                      ...
                      {visibleBanners.length > 0 && (
                        <div className="space-y-3">
                          ...
                          <div
                            className={`p-4 rounded-xl transition-all duration-500 shadow-lg border ${
                              isExpiringSoon(currentBanner?.valid_until)
                          ...
                          >
                            <div className="relative z-10">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <Badge
                                  variant="secondary"
                                  className="bg-white text-primary font-bold text-xs px-2 py-0.5"
                                >
                                  {currentBanner?.discount} OFF
                                </Badge>
                              </div>
                              <h4 className="font-bold text-sm mb-1.5 leading-tight">
                                {currentBanner?.title}
                              </h4>
