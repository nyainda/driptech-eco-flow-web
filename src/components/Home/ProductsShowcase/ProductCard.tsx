    ...
    >
      <Card className="group hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border-2 hover:border-primary/20 overflow-hidden">
          ...
          >
            {product.images && product.images.length > 0 ? (
              ...
              <div className="relative">
                ...
                <IconComponent
                  className={`h-20 w-20 ${colors.color} opacity-70 relative z-10`}
                />
              </div>
            )}
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-2">
              ...
              <Badge
                variant="secondary"
                className="text-xs backdrop-blur-sm bg-white/90 dark:bg-gray-900/90 text-gray-900 dark:text-gray-100 shadow-lg"
              >
                {categoryName}
              </Badge>
            </div>
        ...
        <CardFooter className="p-6 pt-0 flex gap-2">
          ...
          <Button className="flex-1" disabled={!product.in_stock}>
