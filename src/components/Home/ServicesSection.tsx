  ...
  const services = [
    {
      ...
      description:
        "Custom irrigation system design tailored to your specific crop, terrain, and water requirements.",
      features: [
    ...
    },
    {
      ...
      description:
        "Expert installation by certified technicians with comprehensive testing and commissioning.",
      features: [
        "Professional setup",
        "Quality testing",
    ...
    },
    {
      ...
      description:
        "Regular maintenance services and 24/7 technical support to ensure optimal system performance.",
      features: [
    ...
    },
    {
      ...
      description:
        "IoT-enabled monitoring systems with real-time data analytics and automated controls.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive training programs and expert consultation for optimal system operation.",
      features: [
        "Operator training",
        "Best practices",
        "Troubleshooting",
    ...
    },
    {
      ...
      description:
        "Extended warranty coverage and performance guarantees for complete peace of mind.",
      features: [
        "12-month warranty",
  ...
  const {
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select(
          "id, name, description, kit_type, coverage_area, recommended_crops, price, components, installation_complexity, installation_time_hours, water_efficiency_percentage, warranty_months, featured, images",
        )
        .eq("active", true)
        .eq("featured", true)
        .limit(6)
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 mb-6">
            <Badge
              variant="secondary"
              className="px-4 py-2 text-sm font-medium bg-muted text-foreground border-border"
            >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover our professional irrigation kits and comprehensive services
            designed for Kenyan farms to maximize productivity and efficiency.
          </p>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Unable to load kits. Please try again later.
              </p>
            </div>
          ) : kits.length === 0 ? (
            <div className="text-center py-12">
              <Package className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
              <p className="text-muted-foreground">
                No featured kits available at the moment.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  >
                    ...
                    <CardContent className="p-6 space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            {components.pricing_tiers!.length > 2 && (
                              <div className="text-center text-xs text-muted-foreground">
                                +{components.pricing_tiers!.length - 2} more
                                options
                              </div>
                            )}
                          </div>
                      ...
                      {components.main_components &&
                        components.main_components.length > 0 && (
                          <div>
                            <div className="text-sm font-medium mb-2 flex items-center gap-2 text-foreground">
                            ...
                            <ul className="space-y-1">
                              ...
                              {components.main_components.length > 3 && (
                                <li className="text-xs text-muted-foreground text-center">
                                  +{components.main_components.length - 3} more
                                  components
                                </li>
                              )}
                            </ul>
                      ...
                      {components.included_services &&
                        components.included_services.length > 0 && (
                          <div>
                            <div className="text-sm font-medium mb-2 flex items-center gap-2 text-foreground">
        ...
        <div className="bg-muted/30 rounded-2xl p-8 md:p-12 border border-border">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We follow a systematic approach to deliver and support your
              irrigation kit and services for optimal results.
            </p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Consultation",
                desc: "Free site visit and needs assessment",
              },
              {
                step: "02",
                title: "Design",
                desc: "Custom kit and system design",
              },
              {
                step: "03",
                title: "Installation",
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Schedule a free consultation to find the perfect irrigation kit and
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              asChild
            >
              <Link to="/irrigation-kits">Explore All Kits</Link>
            </Button>
            <Button
              size="lg"
              variant="outline"
