...
import { X, Upload, Plus, Layers, CheckCircle2, XCircle, Tag, Palette } from "lucide-react";
      ...
      <CardContent className="p-4 sm:p-6">
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-end gap-3 sm:gap-4 pt-6 border-t border-slate-200 dark:border-gray-700">
            <Button type="button" variant="outline" onClick={onCancel} size="sm" className="h-10 sm:h-11 px-6 sm:px-8 border-slate-300 dark:border-gray-600 hover:bg-slate-50 dark:hover:bg-gray-800">
              Cancel
            </Button>
