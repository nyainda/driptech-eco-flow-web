  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-xl font-semibold">{editingVideo ? "Edit Video" : "Add New Video"}</h3>
      ...
      <Card>
        <CardContent className="p-6 space-y-6">
            ...
            >
              ...
              <TabsContent value="file" className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Supported formats: MP4, WebM, AVI, MOV (Max: 100MB)</p>
                  {formData.video_file && (
                    <div className="mt-2 p-2 bg-muted rounded-md">
                      <div className="flex items-center gap-2">
                        <FileVideo className="h-4 w-4" />
                        <span className="text-sm">{formData.video_file.name}</span>
                        <span className="text-xs text-muted-foreground">({formatFileSize(formData.video_file.size)})</span>
                      </div>
                    </div>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData((prev: any) => ({ ...prev, thumbnail_url: e.target.value }))}
              ...
              <div className="p-3 bg-blue-50 dark:bg-blue-950/20 rounded-md border border-blue-200 dark:border-blue-800">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    A thumbnail will be automatically generated from your video.
                  </p>
                </div>
              </div>
            )}
          ...
          <Button type="button" onClick={onSubmit} disabled={isSaving || isUploading} className="w-full">
            {isUploading ? (
              <>
