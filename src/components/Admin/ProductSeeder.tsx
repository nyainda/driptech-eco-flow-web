...
const ProductSeeder = () => {
  ...
  const irrigationProducts = [
    // Drip Irrigation Systems
    {
      ...
      description:
        "Self-flushing pressure compensating dripper with anti-siphon feature. Operates efficiently between 0.5-4.0 bar pressure. Ideal for uniform water distribution in orchards and vegetable farms.",
      price: 25,
      features: [
    ...
    },
    {
      ...
      description:
        "High-quality dripline with pressure compensating emitters spaced at 30cm intervals. UV stabilized for long-term outdoor use.",
      price: 180,
      features: [
        "Integrated emitters",
        "UV stabilized",
  ...
  const seedProducts = async () => {
    if (hasProducts || hasSeeded) {
      toast({
        ...
        description:
          "Products have already been seeded or exist in the database. Please edit existing products instead.",
        variant: "destructive",
      });
      return;
    }
      ...
      <CardHeader className="p-4 sm:p-6">
        ...
        <CardDescription className="text-xs sm:text-sm">
          ...
          <span className="text-orange-600 ml-1 font-medium">
            Note: Seeding can only be done once. Edit products individually in
            Product Management.
          </span>
        </CardDescription>
      </CardHeader>
        ...
        {isSeeding && (
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs sm:text-sm">
              ...
              <span>
                {seedStats.success + seedStats.failed}/{seedStats.total}
              </span>
            </div>
            <Progress
              value={seedStats.progress}
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs sm:text-sm">
              ...
              <ul className="mt-1 text-yellow-700 dark:text-yellow-300 space-y-1">
                ...
                <li>
                  • Seeded products will have no images - add images via Product
                  Management
                </li>
                <li>
                  • All seeded products can be edited individually in Product
                  Management
                </li>
                <li>
                  • Deletion is disabled here; manage products individually in
                  Product Management
                </li>
              </ul>
            </div>
