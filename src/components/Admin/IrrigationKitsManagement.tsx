...
const IrrigationKitsManagement = () => {
  ...
  const loadData = async (currentPage: number) => {
    ...
    try {
      ...
      // Load installations
      const { data: installationsData, error: installationsError } =
        await supabase
      ...
      if (installationsError) {
        ...
        const transformedInstallations =
    ...
    try {
      const kitData = {
        ...
        components: formData.components
          ? JSON.stringify(formData.components)
          : null,
        ...
        water_efficiency_percentage:
          formData.water_efficiency_percentage || null,
      };
      ...
      resetForm();
      alert(
        selectedKit ? "Kit updated successfully!" : "Kit created successfully!",
      );
    } catch (err) {
  ...
  const addComponent = () => {
    ...
    const components = (formData.components as ComponentsData) || {
      main_components: [],
      pricing_tiers: [],
      included_services: [],
    };
  ...
  const removeComponent = (index: number) => {
    ...
    const updatedComponents = {
      ...components,
      main_components:
        components.main_components?.filter((_, i) => i !== index) || [],
    };
    setFormData({ ...formData, components: updatedComponents });
  };
  ...
  const removePricingTier = (index: number) => {
    ...
    const updatedComponents = {
      ...components,
      pricing_tiers:
        components.pricing_tiers?.filter((_, i) => i !== index) || [],
    };
    setFormData({ ...formData, components: updatedComponents });
  };
  ...
  const removeService = (index: number) => {
    ...
    const updatedComponents = {
      ...components,
      included_services:
        components.included_services?.filter((_, i) => i !== index) || [],
    };
    setFormData({ ...formData, components: updatedComponents });
  };
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from("kit-images").getPublicUrl(filePath);
        ...
        ? Number(
            (
              installations.reduce(
                (sum, inst) => sum + (inst.satisfaction_rating || 0),
                0,
              ) /
                installations.filter(
                  (inst) =>
                    inst.satisfaction_rating && inst.satisfaction_rating > 0,
                ).length || 0
            ).toFixed(1),
          )
        : 0,
    pendingInstallations: installations.filter(
      (inst) => inst.installation_status === "planned",
    ).length,
  };
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-foreground">
              {selectedKit ? "Edit Kit" : "New Irrigation Kit"}
            </h2>
          </div>
          ...
          <Card className="bg-background border-border">
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">
                Configure your irrigation kit specifications
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="kit_type" className="text-foreground">
                    Kit Type *
                  </Label>
                  <Select
                    value={formData.kit_type || ""}
                    onValueChange={(value) =>
                      setFormData({ ...formData, kit_type: value })
                    }
                  >
                    ...
                    <SelectContent className="bg-background border-border text-foreground">
                      <SelectItem value="basic_drip">
                        Basic Drip System
                      </SelectItem>
                      <SelectItem value="advanced_drip">
                        Advanced Drip System
                      </SelectItem>
                      <SelectItem value="sprinkler_system">
                        Sprinkler System
                      </SelectItem>
                      <SelectItem value="greenhouse_kit">
                        Greenhouse Kit
                      </SelectItem>
                      <SelectItem value="hydroponic_kit">
                        Hydroponic Kit
                      </SelectItem>
                      <SelectItem value="smart_irrigation">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label
                    htmlFor="maintenance_level"
                    className="text-foreground"
                  >
                    Maintenance Level
                  </Label>
                  <Select
                    value={formData.maintenance_level || "low"}
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        maintenance_level: value as "low" | "medium" | "high",
                      })
                    }
                  >
                    <SelectTrigger className="bg-background border-border text-foreground">
              ...
              <Card className="border-border">
                <CardHeader className="bg-muted/30">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Add the main components included in this kit
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="border-border">
                <CardHeader className="bg-muted/30">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Define different pricing options (e.g., by number of
                    lines/beds)
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4 pt-4">
                  ...
                  <div className="space-y-2">
                    {components.pricing_tiers?.map((tier, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between bg-muted/30 p-4 rounded-lg border border-border"
                      >
              ...
              <Card className="border-border">
                <CardHeader className="bg-muted/30">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Services included with this kit (training, installation,
                    etc.)
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4 pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="coverage_area" className="text-foreground">
                    Coverage Area (acres)
                  </Label>
                  <Input
                    type="number"
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        coverage_area: parseFloat(e.target.value) || null,
                      })
                    }
                    placeholder="0"
                    className="bg-background border-border text-foreground placeholder-muted-foreground"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <Select
                    value={formData.installation_complexity || "medium"}
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                ...
                <div>
                  <Label htmlFor="efficiency" className="text-foreground">
                    Water Efficiency (%)
                  </Label>
                  <Input
                    type="number"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="target_crop" className="text-foreground">
                    Target Crop
                  </Label>
                  <Input
                    id="target_crop"
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, target_crop: e.target.value })
                    }
                ...
                <div>
                  <Label htmlFor="crops" className="text-foreground">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        recommended_crops: e.target.value
                          .split(",")
                          .map((crop) => crop.trim())
                          .filter((crop) => crop),
                      })
              ...
              <Card className="border-border">
                <CardHeader className="bg-muted/30">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Upload images of your irrigation kit (max 5MB per image)
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4 pt-4">
                  <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-foreground mb-2 tracking-tight">
                    Irrigation Kits Management
                  </h1>
                  <p className="text-muted-foreground text-lg font-medium">
                    Manage irrigation kits, documents, and installations
                  </p>
                  <div className="flex items-center gap-4 mt-3 text-muted-foreground">
                    <span className="text-sm">
                      📦 Total Kits: {kitStats.totalKits}
                    </span>
                    <span className="text-sm">
                      ⭐ Featured: {kitStats.featuredKits}
                    </span>
                    <span className="text-sm">
                      🔧 Installations: {kitStats.totalInstallations}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="kits" className="space-y-6">
            <Card className="bg-background border-border">
              <CardHeader>
                ...
                <CardDescription className="text-muted-foreground">
                  Manage your irrigation kit catalog
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <TableBody>
                            ...
                            <TableCell>
                              {components?.pricing_tiers?.length > 0 ? (
                                ...
                                <span className="text-foreground">
                                  KES {kit.price?.toLocaleString() || "0"}
                                </span>
                              )}
                            </TableCell>
                            <TableCell className="text-foreground">
                              {kit.coverage_area || 0} acres
                            </TableCell>
                            <TableCell>
                              <div className="flex flex-col gap-1">
                                <Badge
                                  variant={kit.active ? "default" : "outline"}
                                  className="border-border text-muted-foreground"
                                >
                      ...
                      {kits.length === 0 && (
                        <TableRow>
                          ...
                          >
                            No irrigation kits found. Create your first kit to
                            get started.
                          </TableCell>
                        </TableRow>
                      )}
          ...
          <TabsContent value="documents" className="space-y-6">
            <Card className="bg-background border-border">
              <CardHeader>
                ...
                <CardDescription className="text-muted-foreground">
                  Installation guides, manuals, and other documentation
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="rounded-lg border border-border">
          ...
          <TabsContent value="installations" className="space-y-6">
            <Card className="bg-background border-border">
              <CardHeader>
                ...
                <CardDescription className="text-muted-foreground">
                  Track kit installations and customer satisfaction
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="rounded-lg border border-border">
                  <Table>
                    ...
                    <TableBody>
                      {installations.map((installation) => (
                        ...
                        >
                          <TableCell className="font-medium text-foreground">
                            {installation.customer_name || "Unknown"}
                          </TableCell>
                          <TableCell className="text-foreground">
                            {installation.kit_name || "Unknown"}
                          </TableCell>
                          <TableCell className="text-foreground">
                            {installation.site_location || "N/A"}
                          </TableCell>
                          <TableCell className="text-foreground">
                            {installation.site_area || 0} acres
                          </TableCell>
                          <TableCell>
                            <Badge
                              variant={
