    ...
    <div className="space-y-6 p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Real-time visitor tracking and insights</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{data.totalVisitors.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{data.totalPageViews.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{data.totalSessions.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{Math.floor(data.averageSessionDuration / 60)}m {data.averageSessionDuration % 60}s</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{data.bounceRate}%</div>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="flex flex-wrap justify-start">
          ...
          <TabsTrigger value="pages" className="flex-1 sm:flex-none">Top Pages</TabsTrigger>
          <TabsTrigger value="products" className="flex-1 sm:flex-none">Products</TabsTrigger>
          <TabsTrigger value="devices" className="flex-1 sm:flex-none">Devices</TabsTrigger>
        </TabsList>
            ...
            <CardContent className="overflow-x-auto">
              <div className="space-y-4 min-w-[600px] sm:min-w-0">
                {data.topPages.map((page, index) => (
                  <div key={page.page_path} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border rounded-lg">
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">{index + 1}</Badge>
                        <h3 className="font-medium text-sm sm:text-base">{page.page_title}</h3>
                      </div>
                      <p className="text-xs sm:text-sm text-muted-foreground">{page.page_path}</p>
                    </div>
            ...
            <CardContent className="overflow-x-auto">
              <div className="space-y-4 min-w-[600px] sm:min-w-0">
                {data.topProducts.map((product, index) => (
                  <div key={product.product_name} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border rounded-lg">
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">{index + 1}</Badge>
